...
class AudioControls:
    ...
    def display_volume(self):
        control_font = pygame.font.Font('C:/Users/Ulan/Pictures/assets/fonts/neue.ttf', 30)
    ...
    def play_music(self, path):
        pygame.mixer.music.load("C:/Users/Ulan/Pictures/assets/sounds/menu.wav")
...
audio_cfg: AudioControls = AudioControls(soundList)
display_cfg: DisplayControls = DisplayControls()
