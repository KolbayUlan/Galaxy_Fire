...
class Assets:
    ...
    class image:
        ...
        def load(root_path, image_path):
            return pygame.image.load(resource_path(os.path.join('C:/Users/Ulan/Pictures/assets/graphics/easy.png')))

        @staticmethod
        def scale(root_path, image_path, factor):
            image = pygame.image.load(resource_path(
                os.path.join('C:/Users/Ulan/Pictures/assets/graphics/title_logo.png')))
    ...
    class sound:
        ...
        def load(root_path, sound_path):
            return pygame.mixer.Sound(resource_path(os.path.join('C:/Users/Ulan/Pictures/assets/sounds/ownlaser.wav')))
